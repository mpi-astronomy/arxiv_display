...
$New detections of the galactic events  ([CHIME/FRB Collaboration, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...54C), [Bochenek, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...59B)) , burst polarisation \citep[e.g.][]{Michilli2018,Luo2020Natur}, burst morphology \citep[e.g.][]{Pleunis2021ApJ}, source periodicity \citep[e.g.][]{Chime2020NaturPeriod,Pastor-Marazuela2021Natur,CHIME2022Natur}, source activity \citep[e.g.][]{Li2021Natur} and host galaxies \citep[e.g.][]{Bassa2017ApJL,Bhandari2022AJ}, have led to constraints on both progenitor models and radiation mechanisms.$
...
$Recently, it is found that magnetospheric radio waves suffer strong dissipation when the wave becomes non-linear and can not escape from the magnetosphere  ([ and Beloborodov 2022](https://ui.adsabs.harvard.edu/abs/2022PhRvL.128y5003B), [Chen, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv221013506C)) .$
...
$However, it is difficult to explain the sub-second scale quasi-periodic oscillations (QPOs) from FRBs  ([CHIME/FRB Collaboration, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022Natur.607..256C), [Pastor-Marazuela, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv220208002P)) .$
$It is also found that neither model can fully explain the X-ray/radio event from SGR 1935+2154  ([ and Wang 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900..172W)) .$
$Recently, a new type of FRB model is proposed where an FRB is radiated as fast-magnetosonic (FMS) waves generated from violent magnetic reconnection triggered by a low-frequency pulse (LFP) compressing the current sheet  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L)) .$
$As the coherent radio emission is produced near the light cylinder, we refer to it as the "intermediate-field" model.$
$Kinetic plasma simulations  ([Philippov, et. al 2019](https://ui.adsabs.harvard.edu/abs/2019ApJ...876L...6P), [Mahlmann, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...932L..20M))  have successfully demonstrated the emission of coherent FMS waves through this mechanism.$
$It is also found that the high linear polarisation  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L))  and the downward frequency drifting  ([Mahlmann, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...932L..20M))  can be well explained.$
$However, the predicted frequency is significantly lower than the observation of the SGR 1935+2154 event  ([ and Wang 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900..172W)) .$
...
$The onset of magnetic reconnection is triggered when the current sheet becomes tearing or kink unstable and breaks into a self-similar chain of plasmoids extending down to the kinetic scale  ([Uzdensky, Loureiro and Schekochihin 2010](https://ui.adsabs.harvard.edu/abs/2010PhRvL.105w5002U)) .$
...
$In highly magnetized systems with magnetization parameter \sigma\equiv B^2/4\pi \rho c^2 \gg1, FMS waves have similar dispersion relation as vacuum electromagnetic waves  ([Thompson and Blaes 1998](https://ui.adsabs.harvard.edu/abs/1998PhRvD..57.3219T), [Li, Zrake and Beloborodov 2019](https://ui.adsabs.harvard.edu/abs/2019ApJ...881...13L))  and can convert to coherent radio waves \citep[e.g.][]{Lyubarsky2019,Philippov2019,Lyubarsky2020ApJ}.$
$It has been proposed that the coherent emission of FRBs are GHz FMS waves generated by the plasmoid collision during magnetic reconnection  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L)) .$
...
$Kinetic simulations have confirmed this process and found that FMS waves takes only a small fraction of the reconnection energy  ([Mahlmann, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...932L..20M)) .$
...
$The typical plasmoid size is found to be proportional to the width of the current sheet \lambda'_c=\varsigma a' with \varsigma\sim10-100  ([Philippov, et. al 2019](https://ui.adsabs.harvard.edu/abs/2019ApJ...876L...6P), [ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L)) , and the width depends on the Larmor radius a'=\varpi r_{\rm L} with \varpi being a few.$
$The plasmoid size can be obtained by balancing the pressure and energy  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L)) ,$
$\begin{eqnarray}$
...
$This expression is confirmed numerically but with a slightly different expression of \eta  ([Mahlmann, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...932L..20M)) .$
$\begin{figure}$
$    \centering$
...
$It has been found that the wave frequency of the toroidal shear modes with the lowest radial node (symbolized by _lt_0) follows \fa(_lt_0)\approx12.2l^{1/2}(l+1)^{1/2} \rm{Hz} with l\geq2 being an integer in the magnetar crust  ([ and Duncan 1998](https://ui.adsabs.harvard.edu/abs/1998ApJ...498L..45D)) .$
...
$The power spectrum of QPOs is found to be dominated by several frequencies depending on the magnetar properties, e.g. Fig. 9 in  ([van Hoven and Levin (2012)](https://ui.adsabs.harvard.edu/abs/2012MNRAS.420.3035V)) , which is in general consistent with observations such as Fig. 3 in  ([Israel, et. al (2005)](https://ui.adsabs.harvard.edu/abs/2005ApJ...628L..53I)) .$
$As the shear wave propagates in the crust, it shakes the anchored magnetic field lines, and launches Alfvén waves into the magnetosphere  ([Thompson and Duncan 2001](https://ui.adsabs.harvard.edu/abs/2001ApJ...561..980T), [Li, Levin and Beloborodov 2016](https://ui.adsabs.harvard.edu/abs/2016ApJ...833..189L), [Thompson, Yang and Ortiz 2017](https://ui.adsabs.harvard.edu/abs/2017ApJ...841...54T), [Bransgrove, Beloborodov and Levin 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897..173B)) .$
...
$When the relative amplitude grows to {\delta B}/{ B}\approx1  ([Yuan, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900L..21Y), [Yuan, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y))  at a distance of$
$\begin{eqnarray}$
...
$A large part of the Alfvén waves will be converted to FMS waves that propagates outwards radially in the form of a LFP  ([Li, Zrake and Beloborodov 2019](https://ui.adsabs.harvard.edu/abs/2019ApJ...881...13L), [Li, Beloborodov and Sironi 2021](https://ui.adsabs.harvard.edu/abs/2021ApJ...915..101L), [Yuan, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021ApJ...908..176Y))  due to the interaction with the curved magnetic field line.$
$The remaining Alfvén waves will dissipate inside the magnetosphere by nonlinear instabilities  ([Yuan, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900L..21Y))  or absorbed by the magnetar  ([Li and Beloborodov 2015](https://ui.adsabs.harvard.edu/abs/2015ApJ...815...25L)) .$
$We here mainly consider the LFP, that can carry a large portion of the energy of Alfvén waves  ([Yuan, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y)) .$
...
$\end{eqnarray}$
$where \boldsymbol{k} is the wavenumber and \boldsymbol{k}_{\rm bg} is the wavenumber of the background magnetic field  ([Yuan, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021ApJ...908..176Y)) .$
...
$The LFP will propagate outward radially with its thickness conserved as found by numerical simulations  ([Yuan, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y)) . Therefore the LFP keeps its wave frequency when propagating.$
$During the propagation of the LFP at r>R_{\rm m}, its toroidal field follows rB_{\rm LFP } = B_{\rm LFP, m}R_{\rm m} with B_{\rm LFP, m}\approx B_{\rm m}  ([Parfrey, Beloborodov and Hui 2013](https://ui.adsabs.harvard.edu/abs/2013ApJ...774...92P), [Yuan, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900L..21Y), [Yuan, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y)) .$
...
$\end{eqnarray}$
$When propagating in the magnetosphere, the FMS waves also suffer from nonlinear steepening when the wave amplitude is comparable to the background magnetic field, and form shocks  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L), [ and Beloborodov 2022](https://ui.adsabs.harvard.edu/abs/2022PhRvL.128y5003B), [Chen, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv221013506C), [ and Beloborodov 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv221013509B)) .$
$Considering the nonlinear steepening caused by the variation of wave velocity across the wavelength, which depends on the local density and magnetic field  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L)) , the shock formation distance is$
$\begin{eqnarray}$
...
$However, the effect of high electric field may still be able to dissipate a fraction of LFP energy  ([ and Beloborodov 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv221013509B)) , which is not considered here.$
...
$\end{eqnarray}$
$The produced FMS waves suffers from nonlinear wave interactions, and it can escape only when its optical depth \tau_{\rm NL}\lesssim10  ([ and Lyubarsky 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L)) , which is given by$
$\begin{eqnarray}$
$    \tau_{\rm NL}\sim \frac{\kappa 2\pi\nu R_{\rm L}}{2\Gamma^2c}=0.5\kappa_{-5.5}\ncc\left(\frac{P}{3 {\rm s}}\right)\Gc^{-2},$
$\end{eqnarray}$
$where \kappa=\Bfms^2/B_{\rm LFP, L}^2 is the energy ratio of the high-frequency FMS waves to the LFP. In 2D simulations, it is found that a fraction \kappa\sim10^{-4} of energy from the LFP is converted to the FMS, interpreted as an upper limit of the efficiency  ([Mahlmann, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...932L..20M)) .$
$The ratio of radio to X-ray energy of FRB200428 is found to be 10^{-6}-10^{-5}  ([Ridnaia, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021NatAs...5..372R)) .$
...
$There are also current sheets behind the LFP inside the magnetosphere, which has been suggested to produce an FRB  ([ and Wang 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900..172W), [Yuan, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...900L..21Y), [Yuan, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y)) .$
$The reconnected fields are the poloidal component  ([Yuan, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y)) , and the frequency of FMS waves produced in those current sheets is$
$\begin{eqnarray}$
...
$Observations show that the FRB from the galactic magnetar, SGR 1935+2154  ([CHIME/FRB Collaboration, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...54C), [Bochenek, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...59B)) , is associated with a hard X-ray burst by several X-ray instruments ([Li, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021NatAs...5..378L), [Mereghetti, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...898L..29M), [Ridnaia, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021NatAs...5..372R), [Tavani, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021NatAs...5..401T)) .$
$This magnetar is of spin period and surface magnetic field P=3.2 s and B_*=2.2\times10^{14} G respectively  ([Olausen and Kaspi 2014](https://ui.adsabs.harvard.edu/abs/2014ApJS..212....6O), [Israel, et. al 2016](https://ui.adsabs.harvard.edu/abs/2016MNRAS.457.3448I)) .$
...
$Especially, a QPO of \fa\approx40 Hz and n_A\gtrsim8 is detected in the X-ray light curve by the Insight-HXMT  ([Li, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022ApJ...931...56L)) .$
$The observed pulse width is 0.3-0.6 ms by CHIME and STARE2 in 0.6-1.3 GHz  ([CHIME/FRB Collaboration, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...54C), [Bochenek, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...59B)) .$
$Substituting \epsilon<1/n_A\sim1/8, W_{\rm p}\sim0.5 ms, and  \nuc\sim1 GHz as well as the observed radio peak luminosity L_{\rm FMS}\approx10^{38} erg/s  ([Bochenek, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020Natur.587...59B), [Zhou, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...905...99Z))  into Eqs. (\ref{eq:nu_final}, \ref{eq:tpulse} and \ref{eq:lfrb}), we obtain \Gamma\sim50, \zeta\gtrsim3.5\eta_1^{1/2} and L_A\approx 1.4\times10^{40} \kappa_{-5.5}^{-1} erg/s.$
...
$And the required L_A is comparable to the observed X-ray luminosity, 10^{40}~erg/s  ([Mereghetti, et. al 2020](https://ui.adsabs.harvard.edu/abs/2020ApJ...898L..29M), [Li, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021NatAs...5..378L)) .$
$Therefore, our model can explain this event self-consistently.$
$QPO signals are also observed in individual FRB events, such as the 4.6 Hz QPO in FRB 20191221A, 357.1 Hz in FRB 20210206A, 93.4 Hz in FRB 20210213A detected by CHIME  ([CHIME/FRB Collaboration, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022Natur.607..256C)) , and the 2.4 kHz QPO in FRB 20201020A detected by Apertif  ([Pastor-Marazuela, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv220208002P)) .$
$It has been suggested that the 4.6 Hz QPO may be caused by the magnetar spin period   ([Beniamini and Kumar 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv221107669B)) , however, such a spin-period scenario will be difficult to explain the high-frequency QPOs, especially the 2.4 kHz one  ([Pastor-Marazuela, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022arXiv220208002P)) . While the magnetar oscillation can offer a natural explanation.$
$The observed QPOs with frequencies larger than 93.4 Hz mentioned above can be explained by the overtones in a wide parameter range. While the 4.6 Hz QPO in FRB 20191221A may relate to the fundamental mode. We here focus on this source, which has the highest significance  ([CHIME/FRB Collaboration, et. al 2022](https://ui.adsabs.harvard.edu/abs/2022Natur.607..256C)) .$
...
$In this paper,$
$we generalized the wave dynamics in the magnetosphere from the previous simulations results in  ([Yuan, et. al (2020)](https://ui.adsabs.harvard.edu/abs/2020ApJ...900L..21Y), [Yuan, et. al (2022)](https://ui.adsabs.harvard.edu/abs/2022ApJ...933..174Y))  and applied it in the intermediate-field FRB model.$
...
$The major difference of our calculations from  ([ and Lyubarsky (2020)](https://ui.adsabs.harvard.edu/abs/2020ApJ...897....1L))  is the treatment of magnetic field configurations of the LFP and the magnetar wind, as we considered the wave dynamics in the magnetosphere.$
...
$Our model can also naturally explain the observed wide energy span detected in a relative narrow frequency band, such as the broad energy range (4\times10^{36}-8\times10^{39} erg) observed in FRB 121102 at 1.25 GHz  ([Li, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021Natur.598..267L)) , as the frequency does not depend on the flare energy apparently.$
...
$The peak at 3.4 ms in the waiting time distribution of FRB 121102 may be such a case  ([Li, et. al 2021](https://ui.adsabs.harvard.edu/abs/2021Natur.598..267L)) .$
