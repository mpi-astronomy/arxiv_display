...
**Figure 3. -** PBB mass fraction distribution of $H_2$O for T<150 K (outer proto-planetary disc) in the [$\alpha$/Fe]-[Fe/H] diagram. We display the surveys APOGEE-DR17 (top panels) and GALAH-DR3 (bottom panels). (*Fig7_Mfrac_AlphaFe_Outer*)
...
</div><div id="qrcode"><img src=https://api.qrserver.com/v1/create-qr-code/?size=100x100&data="https://arxiv.org/abs/2301.05034"></div>