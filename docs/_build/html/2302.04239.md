...
# Simulation of $CH_3$OH ice UV photolysis under laboratory conditions
...
**Figure 37. -** Formation curves of selected daughter species ($CH_2$OH, CO, $CO_2$, $CH_4$, HCO and $H_2$CO) due to $CH_3$OH photolysis over fluence with respect to the initial methanol ice column density at four temperatures. The symbols are the experimental measurements and the solid lines are the results of ProDiMo simulations of the best photodissociation models (see Figure \ref{fits}). (*growth*)

</div><div id="qrcode"><img src=https://api.qrserver.com/v1/create-qr-code/?size=100x100&data="https://arxiv.org/abs/2302.04239"></div>