...
# Magnetism, rotation, and nonthermal emission in cool stars$\thanks{Table    B.1 is available in electronic form at the CDS via anonymous ftp to    cdsarc.u-strasbg.fr (130.79.128.5) or via    \url{http://cdsweb.u-strasbg.fr/cgi-bin/qcat?J/A+A/}. MCMC posteriors    together with all spectral line fits and field component distributions are    available at \url{http://carmenes.cab.inta-csic.es/}.}$

</div>
<div id="comments">

[![arXiv](https://img.shields.io/badge/arXiv-2204.00342-b31b1b.svg)](https://arxiv.org/abs/2204.00342)<mark>Appeared on: 2022-04-01</mark> - _A&A accepted, abstract abbreviated, 20 pages, Table B.1 included in arXiv version, full MCMC posteriors and linefit plots are available at this http URL_
...
**Figure 3. -**  Magnetic field-rotation relation for
...
**Figure 2. -** Period-mass diagram indicating magnetic field
...
<img src="" alt="Fig4" width="100%"/>

**Figure 4. -** Alternative version of the
    rotation-magnetic field relation. *Top panel:* Ratio of average
...
</div><div id="qrcode"><img src=https://api.qrserver.com/v1/create-qr-code/?size=100x100&data="https://arxiv.org/abs/2204.00342"></div>